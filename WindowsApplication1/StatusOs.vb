Public Class StatusOs
    ...
    Public Overrides Sub inicio()
        'MyBase.inicio()
        Me.PkString = False
        Me.Tabela = "CG_STATUS_OS" 'Nome da tabela no SQL
        Me.Modulo = 6 'codigo do módulo 
        ...
        Me.ObjModel = New DTO.Cg_status_os
        Me.ColunaId = "ID_STATUS"
    ...
    Public Overrides Sub Carrega_Controles_Pesquisa()
        ...
        If Me.KeyId <> -1 Then
            ...
            txtDescricao.Text = Me.LinhaGrid.Cells("desc_status").Value.ToString
        End If
    End Sub
    Public Overrides Sub Gravar(acao As Integer)
        ...
        End If
        'MyBase.Gravar(acao)
        Dim bll As New BLL.Status_osBLL
        Dim objStatusOS As New DTO.Cg_status_os
        Try
            objStatusOS.Id_status = CInt(txtCodigo.Text)
            objStatusOS.Desc_status = txtDescricao.Text
            objStatusOS.User_ins = ACE_CODIGO
            objStatusOS.Data_ins = Hoje()
            objStatusOS.User_upd = ACE_CODIGO
            objStatusOS.Data_upd = Hoje()

            bll.GravarBLL(acao, objStatusOS)
