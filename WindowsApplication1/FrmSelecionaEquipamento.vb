Public Class frmSelecionaEquipamento
    ...
    Public Sub New(ByVal _id As Integer, ByVal _idlojaorigem As Integer, ByRef _gridDados As DataGridView, _procSQL As String)
