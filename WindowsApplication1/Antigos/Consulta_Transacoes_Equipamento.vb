...
Public Class Consulta_Transacoes_Equipamento
    ...
    Private Sub Inicio()
        ...
        sql += "WHERE  TIPO_PRODUTO = 'E' AND DATAMOV >= '" & Dtos(txtData1.Text) & "' AND DATAMOV < '" & Dtos(SomaData("D", +1, txtData2.Text)) & "'"
    ...
    Private Sub CarregaItens(ByVal _romaneio As String)
        ...
        Dim sql As String
        sql = "SELECT ROMANEIO, ID_PRODUTO, SERIE, MODELO, DESC_EQUIPAMENTO, ENTRADA_SAIDA, "
        sql += "QUANTIDADE, TRANSITO, ID_TRANSACAO, DESC_TRANSACAO, ID_LOCAL_DE, NOME_ORIGEM, SIGLA_ORIGEM, ID_LOCAL_PARA, "
        sql += "NOME_DESTINO, SIGLA_DESTINO, DATAMOV, OBSERVACAO, UNIQUE_KEY FROM VW_ROMANEIO_ESTOQUE_ITEM_EQUIPAMENTO "
