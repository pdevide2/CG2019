...
Public Class DevolucaoEquipamento_Edicao
    ...
    Private Sub EntradaEquipamento_Edicao_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Carrega_Dados()
        If Me.Modo = "existe" Then
            ...
            txtIdMotivo.Text = Me.LinhaDados.Cells("ID_MOTIVO").Value.ToString
            txtDescMotivo.Text = Me.LinhaDados.Cells("DESC_MOTIVO").Value.ToString
        End If
    End Sub
    ...
    Private Sub btnPesqEquipamento_Click(sender As Object, e As EventArgs) Handles btnPesqEquipamento.Click
        If btnEditaSalva.Text = "Novo" Then
        ...
        Me.ObjModelFk.Tabela = "VW_CG_EQUIPAMENTOS_DISPONIVEIS_DEVOLUCAO_MATRIZ"
        Me.ObjModelFk.CampoId = "ID_Equipamento"
        Me.ObjModelFk.CampoDesc = "DESC_EQUIPAMENTO"
        Me.ObjModelFk.LabelBuscaId = "Código"
        Me.ObjModelFk.LabelBuscaDesc = "Descrição Equip."
        ...
        txtSerie.Text = Me.ObjModelFk.txtDesc

        'Se código do Equipamento selecionado for valido, traz o resto dos campos 
        If (txtIdEquipamento.Text <> "" And txtIdEquipamento.Text <> "0") Then
            ...
            comandoSQL = "SELECT CG_Equipamento.ID_Equipamento,"
            comandoSQL += "CG_Equipamento.SERIE,CG_Equipamento.MODELO,CG_Equipamento.DESC_EQUIPAMENTO,"
            comandoSQL += "CG_Equipamento.VALOR, CAST(1 AS INT) AS QTD "
            ...
            If myRow.Count > 0 Then
                ...
                txtModelo.Text = myRow(0)(2).ToString
                txtDescEquipamento.Text = myRow(0)(3).ToString
            ...
            Else
                ...
                txtDescEquipamento.Text = String.Empty
    ...
    Private Sub HabilitaBotoesFilha(ByVal _acao As Integer)
        ...
        btnPesqEquipamento.Enabled = blnModo
