Public Class EntradaChip
    ...
    Public Overrides Sub inicio()
        ...
        Me.PkString = False
        Me.Tabela = "CG_ENTRADA_CHIP" 'Nome da tabela no SQL
        Me.View = "VW_CG_ENTRADA_CHIP"
    ...
    Public Overrides Sub Gravar(acao As Integer)
        ...
        Dim bllPai As New BLL.Entrada_chipBLL
        Dim objEntradaChip As New DTO.Cg_entrada_chip

        Dim bllFilha As New BLL.Entrada_chip_itemBLL
        Dim objEntradaChipItem As New DTO.Cg_entrada_chip_item

        Try
            objEntradaChip.Id_romaneio = CInt(txtCodigo.Text)
            objEntradaChip.Data_movto = CDate(txtDataMovto.Text)
            objEntradaChip.Id_loja = CInt(txtIdLoja.Text)
            ...
            bllPai.GravarBLL(acao, objEntradaChip)
            ...
            sqlquery += "FROM CG_ENTRADA_CHIP_ITEM WHERE ID_ROMANEIO = " & objEntradaChip.Id_romaneio.ToString

            strItens = BLL.GlobalBLL.PesquisarFkListaBLL(sqlquery)

            'Percorre o array e exclui item a item 
            objEntradaChipItem.Id_romaneio = objEntradaChip.Id_romaneio
