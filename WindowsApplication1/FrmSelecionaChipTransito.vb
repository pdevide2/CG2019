Public Class frmSelecionaChipTransito
    ...
    Public Sub New(ByVal _idlojaorigem As Integer, ByRef _gridDados As DataGridView, _procSQL As String)
    ...
    Public Sub Carregar()
        ...
        If Len(Trim(pesquisaNoGrid.Text)) > 0 Then
            Me.Filtro = Me.LojaOrigem & ", " & IIf(optPesq1.Checked = True, 1, 2) & _
                ...
                If Not row.IsNewRow Then
                    ...
                    If row.Cells(0).Value = True Then 'Verifica se o checkbox está clicado
                        ...
                        Try
                            ...
                            Else
                                MessageBox.Show(IIf(Me.TipoEstoque = "C", "SIMID ", "POS Série ") & _
                                                row.Cells(2).Value.ToString & " não incluído, pois já " & _
                                                "está inserido!", "Aviso", MessageBoxButtons.OK, _
