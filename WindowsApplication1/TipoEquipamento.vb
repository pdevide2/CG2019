Public Class TipoEquipamento
    ...
    Public Overrides Sub inicio()
        'MyBase.inicio()
        Me.PkString = False
        Me.Tabela = "CG_TIPO_EQUIPAMENTO" 'Nome da tabela no SQL
        Me.Modulo = 11 'codigo do módulo 
        ...
        Me.ObjModel = New DTO.Cg_tipo_equipamento
        Me.ColunaId = "ID_TIPO_EQUIPAMENTO"
    ...
    Public Overrides Sub Carrega_Controles_Pesquisa()
        ...
        If Me.KeyId <> -1 Then
            ...
            txtDescricao.Text = Me.LinhaGrid.Cells("DESC_TIPO_EQUIPAMENTO").Value.ToString
        End If
    End Sub
    Public Overrides Sub Gravar(acao As Integer)
        ...
        End If
        'MyBase.Gravar(acao)
        Dim bll As New BLL.Tipo_equipamentoBLL
        Dim objTipoEquipamento As New DTO.Cg_tipo_equipamento
        Try
            objTipoEquipamento.Id_tipo_equipamento = CInt(txtCodigo.Text)
            objTipoEquipamento.Desc_tipo_equipamento = txtDescricao.Text
            objTipoEquipamento.User_ins = ACE_CODIGO
            objTipoEquipamento.Data_ins = Hoje()
            objTipoEquipamento.User_upd = ACE_CODIGO
            objTipoEquipamento.Data_upd = Hoje()

            bll.GravarBLL(acao, objTipoEquipamento)
