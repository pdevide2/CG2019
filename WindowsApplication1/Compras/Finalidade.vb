...
Public Class Finalidade
    ...
    Public Overrides Sub inicio()
        'MyBase.inicio()
        Me.PkString = False
        Me.Tabela = "CG_Finalidade" 'Nome da tabela no SQL
        Me.Modulo = 47 'codigo do módulo 
        ...
        Me.ObjModel = New DTO.Cg_finalidade
        Me.ColunaId = "ID_Finalidade"
    ...
    Public Overrides Sub Carrega_Controles_Pesquisa()
        ...
        If Me.KeyId <> -1 Then
            ...
            txtDescricao.Text = Me.LinhaGrid.Cells("DESC_Finalidade").Value.ToString
        End If
    End Sub
    Public Overrides Sub Gravar(acao As Integer)
        ...
        End If
        'MyBase.Gravar(acao)
        Dim bll As New BLL.FinalidadeBLL
        Dim objFinalidade As New DTO.Cg_finalidade
        Try
            objFinalidade.Id_finalidade = CInt(txtCodigo.Text)
            objFinalidade.Desc_finalidade = txtDescricao.Text
            objFinalidade.User_ins = ACE_CODIGO
            objFinalidade.Data_ins = Hoje()
            objFinalidade.User_upd = ACE_CODIGO
            objFinalidade.Data_upd = Hoje()
            objFinalidade.Id_empresa = Publico.Id_empresa

            bll.GravarBLL(acao, objFinalidade)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs)
        'Dim frm As New WinCG.ExcelForm
        'frm.Show()
    End Sub
End Class