...
Public Class Estoque_chip
    ...
    Private Sub Inicio()
        ...
        sql += "ID_LOCAL_ESTOQUE, ID_LOCAL, ID_OPERADORA  "
        sql += " FROM VW_CG_ESTOQUE_CHIP WHERE 1=1 "
    ...
    Private Sub UpdateFont()
        ...
        colHeader = {"Id Chip", "SIMID", "Operadora", "Estoque", _
                     "Transito", "Custo", "Codigo", "Nome Local", "Loja Física", _
                     "Área", "Tipo Local", "Dt. Movto", "Sigla", _
                      "Id Local Estoque", "Id Local", "Id Operadora"}
    ...
    Private Sub txtDescTransito_TextChanged(sender As Object, e As EventArgs) Handles txtDescTransito.TextChanged

    End Sub

    Private Sub txtIdTransito_TextChanged(sender As Object, e As EventArgs) Handles txtIdTransito.TextChanged
