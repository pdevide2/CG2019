Public Class RecebimentoChip
    ...
    Public Sub Carregar()
        ...
        sql += "NOME_DESTINO,ID_RESPONSAVEL,APELIDO from VW_CG_MOVIMENTO_CHIP WHERE 1 = 1 AND (QTD_RECEBIDA <> QTD_TOTAL) AND "
    ...
    Public Sub CarregarItens(ByVal _linhaGrid As DataGridViewRow, ByVal blnEditar As Boolean)
        ...
        sql += "ID_CHIP, SIMID, ID_OPERADORA, DESC_OPERADORA, QTD, VALOR, ID_ROMANEIO, UNIQUE_KEYID, TRANSITO "
    ...
    Private Sub GravarRomaneio(ByVal _linhaGrid As DataGridViewRow)
        ...
        sqlEmpty = "update CG_MOVIMENTO_CHIP_ITEM SET TRANSITO = {0} WHERE ID_ROMANEIO={1} AND UNIQUE_KEYID = '{2}'"
        ...
        Try
            ...
            sql = "UPDATE CG_MOVIMENTO_CHIP SET QTD_RECEBIDA = QTD_RECEBIDA + {0} WHERE ID_ROMANEIO = {1}"
    ...
    Private Sub dgvDados1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvDados1.CellContentClick
