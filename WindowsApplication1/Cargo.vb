...
Public Class Cargo
    ...
    Public Overrides Sub inicio()
        'MyBase.inicio()
        Me.PkString = False
        Me.Tabela = "CG_CARGO" 'Nome da tabela no SQL
        Me.Modulo = 9 'codigo do módulo 
        ...
        Me.ObjModel = New DTO.Cg_cargo
        Me.ColunaId = "ID_CARGO"
    ...
    Public Overrides Sub Carrega_Controles_Pesquisa()
        ...
        If Me.KeyId <> -1 Then
            ...
            txtDescricao.Text = Me.LinhaGrid.Cells("desc_cargo").Value.ToString
        End If
    End Sub
    Public Overrides Sub Gravar(acao As Integer)
        ...
        'MyBase.Gravar(acao)
        Dim bll As New BLL.CargoBLL
        Dim objCargo As New DTO.Cg_cargo
        Try
            objCargo.Id_cargo = CInt(txtCodigo.Text)
            objCargo.Desc_cargo = txtDescricao.Text
            objCargo.User_ins = ACE_CODIGO
            objCargo.Data_ins = Hoje()
            objCargo.User_upd = ACE_CODIGO
            objCargo.Data_upd = Hoje()
            objCargo.Id_empresa = Publico.Id_empresa

            bll.GravarBLL(acao, objCargo)
    ...
    Public Overrides Function ValidaCampos() As Object
        Try
            If String.IsNullOrEmpty(txtDescricao.Text) Then
                Throw New Exception("Atenção Descrição do Cargo deve ser preenchida!")
            End If
        Catch ex As Exception
