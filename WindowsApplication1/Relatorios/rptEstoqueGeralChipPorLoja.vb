...
Public Class rptEstoqueGeralChipPorLoja
    ...
    Private Sub Inicio()
        ...
        comandoSQLGrid = "exec spRpt_EstoqueChipTotalPorLoja"
    ...
    Private Sub AtualizarQuery()
        ...
        Try
            ...
            Me.ComandoSQLChart = "exec spRpt_EstoqueChipTotalPorLoja " & Me.FiltroComEstoque & ", " & Me.FiltroChart
    ...
    Private Sub FormataChart()
        ...
        With Chart1
            ...
            .Series(0).LegendText = "Estoque de Chip"
