...
#Region "Private methods"
    ...
    Private Sub PrintFooter(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        '\- Método alterado - acrescentado Impresso por - usuario logado e hora atual na data - Pagina em Português
        If _FooterRectangle.Height > 0 Then
            ...
            Call DrawCellString("Impresso por " & _LoggedInUsername, CellTextHorizontalAlignment.LeftAlign, CellTextVerticalAlignment.MiddleAlign, _FooterRectangle, False, e.Graphics, _PrintFont, Brushes.White)
            Call DrawCellString(DateTime.Now.ToLongDateString & " " & DateTime.Now.ToShortTimeString, CellTextHorizontalAlignment.CentreAlign, CellTextVerticalAlignment.MiddleAlign, _FooterRectangle, False, e.Graphics, _PrintFont, Brushes.White)
            Call DrawCellString("Página " & (((_CurrentPageDown - 1) * PagesAcross) + _CurrentPageAcross).ToString, CellTextHorizontalAlignment.RightAlign, CellTextVerticalAlignment.MiddleAlign, _FooterRectangle, False, e.Graphics, _PrintFont, Brushes.White)
        End If
    ...
    Private Function GridColumnCount() As Integer
        ...
        If _GridColumnCount = 0 Then
            ...
            ElseIf (_dataGridView IsNot Nothing) Then
                If TypeOf _dataGridView.DataSource Is DataTable Then
                    _GridColumnCount = CType(_dataGridView.DataSource, DataTable).Columns.Count
                ElseIf TypeOf _dataGridView.DataSource Is DataSet Then
                    _GridColumnCount = CType(_dataGridView.DataSource, DataSet).Tables(_DataGrid.DataMember).Columns.Count
                ElseIf TypeOf _dataGridView.DataSource Is DataView Then
                    _GridColumnCount = CType(_dataGridView.DataSource, DataView).Table.Columns.Count
                Else
                    'TODO : Get the column count....
                End If
            End If
    ...
    Private Function GridRowCount() As Integer
        ...
        If _GridRowCount = 0 Then
            ...
            ElseIf (_dataGridView IsNot Nothing) Then
                If TypeOf _dataGridView.DataSource Is DataTable Then
                    _GridRowCount = CType(_dataGridView.DataSource, DataTable).DefaultView.Count
                ElseIf TypeOf _dataGridView.DataSource Is DataSet Then
                    _GridRowCount = CType(_dataGridView.DataSource, DataSet).Tables(_DataGrid.DataMember).DefaultView.Count
                ElseIf TypeOf _dataGridView.DataSource Is DataView Then
                    _GridRowCount = CType(_dataGridView.DataSource, DataView).Table.DefaultView.Count
                Else
                    'TODO : Get the column count....
                End If
            End If
    ...
    Private Function GetColumnHeadingText(ByVal Column As Integer) As String
        ...
        ElseIf (_dataGridView IsNot Nothing) Then
            ...
            If TypeOf _dataGridView.DataSource Is DataTable Then
                Return CType(_dataGridView.DataSource, DataTable).Columns(Column).Caption
            ElseIf TypeOf _dataGridView.DataSource Is DataSet Then
                Return CType(_dataGridView.DataSource, DataSet).Tables(0).Columns(Column).Caption
            ElseIf TypeOf _dataGridView.DataSource Is DataView Then
                Return CType(_dataGridView.DataSource, DataView).Table.Columns(Column).Caption
            End If
