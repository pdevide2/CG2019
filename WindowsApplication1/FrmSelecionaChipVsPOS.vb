Public Class FrmSelecionaChipVsPOS
    ...
    Public Property Equipamento() As Integer
        Get
    ...
    Public Sub New(ByVal _id As Integer, ByVal _idEquipamento As Integer, ByRef _gridDados As DataGridView)
        ...
        Me.Equipamento = _idEquipamento.ToString

        ' Add any initialization after the InitializeComponent() call.

    End Sub
    Public Sub Carregar(ByVal _filtro_incremental As String)
        Dim sql As String
        sql = "EXEC spSelecionaChip_POS "
        Me.Comando = sql
        ...
        Me.Filtro = Me.Equipamento & ",'" & listaIdIncluidos() & "', '" & _filtro_incremental & "'"
        ...
        coluna3.HeaderText = "Operadora ID"
        ...
        If dgvDados.RowCount = 0 Then
            MessageBox.Show("Não existem CHIPs disponiveis para vincular com POS informado.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End If
    ...
    Private Sub pesquisaNoGrid_TextChanged(sender As Object, e As EventArgs) Handles pesquisaNoGrid.TextChanged
        Try
            If String.IsNullOrEmpty(pesquisaNoGrid.Text) Then

                Carregar("")

            Else

                Carregar(Trim(pesquisaNoGrid.Text))
