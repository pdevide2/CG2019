...
Public Class Categoria
    ...
    Public Overrides Sub inicio()
        'MyBase.inicio()
        Me.PkString = False
        Me.Tabela = "CG_Categoria" 'Nome da tabela no SQL
        Me.Modulo = 46 'codigo do módulo 
        ...
        Me.ObjModel = New DTO.Cg_categoria
        Me.ColunaId = "ID_Categoria"
    ...
    Public Overrides Sub Carrega_Controles_Pesquisa()
        ...
        If Me.KeyId <> -1 Then
            ...
            txtDescricao.Text = Me.LinhaGrid.Cells("DESC_Categoria").Value.ToString
        End If
    End Sub
    Public Overrides Sub Gravar(acao As Integer)
        ...
        End If
        'MyBase.Gravar(acao)
        Dim bll As New BLL.CategoriaBLL
        Dim objCategoria As New DTO.Cg_categoria
        Try
            objCategoria.Id_categoria = CInt(txtCodigo.Text)
            objCategoria.Desc_categoria = txtDescricao.Text
            objCategoria.User_ins = ACE_CODIGO
            objCategoria.Data_ins = Hoje()
            objCategoria.User_upd = ACE_CODIGO
            objCategoria.Data_upd = Hoje()
            objCategoria.Id_empresa = Publico.Id_empresa

            bll.GravarBLL(acao, objCategoria)
