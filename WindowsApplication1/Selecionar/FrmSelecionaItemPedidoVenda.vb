Public Class frmSelecionaItemPedidoVenda
    ...
    Public Sub New(ByVal _id_Pedido As String, ByRef _gridDados As DataGridView, _procSQL As String)
    ...
    Public Sub Carregar()
        ...
        coluna7.HeaderText = "Preco Venda R$"
        coluna7.Name = "PRECO_VENDA"
    ...
    Private Sub PesqFKLojaOrigem_Load(sender As Object, e As EventArgs) Handles PesqFKLojaOrigem.Load
        With Me.PesqFKLojaOrigem
            ...
            'Valor default já vem selecionado empresa matriz e não pode alterar
            .txtId.Text = "1"
            .txtDesc.Text = "MATRIZ"
    ...
    Private Sub frmSelecionaItemPedidoVenda_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        optPesq1.Checked = False
        optPesq2.Checked = True
        Me.TipoEstoque = "E" 'IIf(Me.ProcSQL = "spSelecionaEstoqueChipLoja", "C", "E")
