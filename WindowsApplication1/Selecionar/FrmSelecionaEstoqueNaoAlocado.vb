Public Class FrmSelecionaEstoqueNaoAlocado
    ...
    Public Sub New(ByVal _id As Integer, ByVal _idlojaorigem As Integer, _
                   ByRef _gridDados As DataGridView, ByVal _tipoEstoque As String)
        ...
        '==> LOJA ORIGEM = 0 (ZERO) AINDA NÃO FOI ALOCADO NO ESTOQUE
        Me.LojaOrigem = "0" '_idlojaorigem.ToString 
        Me.TipoEstoque = _tipoEstoque '(C) chip ou (E) Equipamento/POS
    ...
    Public Sub Carregar()
        ...
        If Me.TipoEstoque = "C" Then
            sql = "EXEC spSelecionaChipNaoAlocado "
        Else
            sql = "EXEC spSelecionaEquipamentoMovimentoNaoAlocado "
        End If
        ...
        Me.Filtro = Publico.Id_empresa & ", " & Me.LojaOrigem & ",'" & listaIdIncluidos() & "'"

        If Len(Trim(pesquisaNoGrid.Text)) > 0 Then
            Me.Filtro = Publico.Id_empresa & ", " & Me.LojaOrigem & ",'" & listaIdIncluidos() & "', " & _
    ...
    Private Sub frmSelecionaChip_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        pesquisaNoGrid.Text = ""
        If Me.TipoEstoque = "C" Then
            Me.Text = "Seleção de Chip para Entrada no Estoque da Matriz"
            Label1.Text = "SIMID"
        Else
            Me.Text = "Seleção de Equipamento (POS) para Entrada no Estoque da Matriz"
            Label1.Text = "Série#"
        End If
        Carregar()
    End Sub
    ...
    End Sub
    'ROTINA ANTIGA ==> LOCALIZA A LINHA MAIS NÃO EXCLUI DO GRID
    ...
    'End Sub
    'ROTINA NOVA => LOCALIZA AS LINHAS EXCLUINDO DO GRID OU APENAS LOCALIZA A LINHA SEM EXCLUIR DO GRID
    Private Sub btnPesquisa_Click(sender As Object, e As EventArgs) Handles btnPesquisa.Click
