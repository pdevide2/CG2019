...
/****** Object:  View [dbo].[VW_CG_CHIP_DISPONIVEIS_DEVOLUCAO_MATRIZ]    Script Date: 02/04/2017 21:25:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[VW_CG_CHIP_DISPONIVEIS_DEVOLUCAO_MATRIZ]
AS
...
WHERE 
    CG_CHIP.ID_LOCAL_ESTOQUE = 1 AND 
	(CG_CHIP.ID_CHIP NOT IN (SELECT A.ID_CHIP FROM CG_DEVOLUCAO_CHIP_ITEM A (NOLOCK)))
