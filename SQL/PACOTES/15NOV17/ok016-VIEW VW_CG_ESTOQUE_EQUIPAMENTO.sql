...
/****** Object:  View [dbo].[VW_CG_ESTOQUE_EQUIPAMENTO]    Script Date: 15/11/2017 16:49:16 ******/
DROP VIEW [dbo].[VW_CG_ESTOQUE_EQUIPAMENTO]
GO
...
CREATE VIEW [dbo].[VW_CG_ESTOQUE_EQUIPAMENTO]
AS
SELECT
    A.ID_EQUIPAMENTO, 
    B.SERIE, 
